...
function Post(props) {
    ...
    let items = [];
    const loadActiveCategories = () => fetch(`${api}/admin/getcategoria/${id}`, { method: 'POST', mode: 'cors', cache: 'default' })
    ...
    return (
        <div className="content-fluid" style={{ marginTop: 66 }}>
            ...
            <NavBar />
            <Async promiseFn={loadActiveCategories}>
                                            ...
                                            <div className="col-md-12">
                                                <div className="carousel-inner">
                                                    <div className={'carousel-item ' + (index === 0 ? 'active' : '')} key={index}>
                                                        <img src={assets + 'categorias/' + rows.image} className="d-block w-100" alt={rows.image} />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
