...
class ItemsNumberFive extends Component {
    ...
    mostrarCategoria = (valor) => {
        ...
        searchByCategories(valor, 0,'marcaFive');
    };

    async componentDidMount(){
        // Categorias para mostrar al inicio del modelo    redPolar
        await apiClient.getCategoriesHome('marcaFive').then(result => {
            this.setState({
