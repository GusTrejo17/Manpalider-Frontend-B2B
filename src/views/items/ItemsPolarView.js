...
class ItemsPolarView extends Component {
    ...
    mostrarCategoria = (valor) => {
        ...
        searchByCategories(valor, 0,'marcaOne');
        
    };

    async componentDidMount(){
        // Categorias para mostrar al inicio del modelo    redPolar
        await apiClient.getCategoriesHome('marcaOne').then(result => {
            this.setState({
    ...
    render() {
        ...
        return (
            <div className="container-fluid" style={{marginTop: 176,backgroundColor:config.Back.backgroundColor , paddingLeft:0, paddingRight:0}}>
                ...
                <NavBar/>
                {/* Banner */}
                {/* <div className="bannerRedCompensas margenS" style={{}}>
                    <img id = "scrollDownPlease" className="img-fluid"
                        src={require('../../images/diasa/redPolar/Banner1.jpg')}
                        alt="Segundo NavBar"
                    />
                </div>  */}
                {/* Si es un video */}
