...
class ItemRelatedSlider extends Component {
    ...
    changeQuantity = (index, item, event) =>{
        const {changeQuantity, notificationReducer: {showAlert},items1} = this.props; 
        let newQuantity;
        items1.map( itemFilter => {
    ...
    render() {
        const {itemsReducer : { searchItemsFilter, updateFavorite, deleteShoppingCart, openItemDetails }, dashboard, changeBackOrder,items1,setItemsRelated } = this.props;
            ...
            <div>
                ...
                <div className="" style={{}}>
                    {false? 
                        ...
                        // </>
                        <><br></br><div className='container-fluid p-0'><h2>También puedes agregar</h2>
                        <Carousel708 
                            items={items1} 
                            valor={valor} 
                            seller={seller} 
                            ...
                            view={"slider1"}
                            list={3}
                            setItemsRelated={setItemsRelated}
                        />
                        </div></>
                    }
                </div>
