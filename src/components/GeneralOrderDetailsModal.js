...
class GeneralOrderDetailsModal extends Component {
    async addToShopingCart(){
        ...
        if(responsesd.status === 1){
            $('#generalOrderDetailsModal').modal('hide');
    ...
    render() {
        ...
        return (
            <div className="modal fade" id="generalOrderDetailsModal" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" style={{border: "none", textAlign: 'center'}}>
                <div className="modal-dialog modal-xl" role="document" style={{margin: '1.75rem auto'}}>
                    <div className="modal-content">
                        <div className="modal-header" style={{background:'#0060EA'}}>
                            <h5 className="modal-title" style={{color: config.navBar.textColor2,fontSize:'1.2rem'}}>Productos de la orden</h5>
                                                                ...
                                                                <table className="table">
                                                                    ...
                                                                    <tbody style={{fontSize:"1rem"}}> 
                                                                        <tr>
                                                                            ...
                                                                            <td> {item.OpenQty ? parseInt(item.OpenQty) : '--'} </td>
