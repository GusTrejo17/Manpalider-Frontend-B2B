...
class CarouselAdvantages extends Component {
    

    render() {
        const {redirectPaymentMethod, redirectSafeShopping} = this.props

        return (
            <Carousel className="carouselMarcas mt-3" style={{ justifyContent: "center", alignItems: "center"}} autoPlay infinite={true} draggable partialVisible={true} responsive={responsiveMarcas} autoPlaySpeed={5000} customLeftArrow={<div />} customRightArrow={<div />}>   
                ...
                <div className="text-center" style={{marginTop: "auto", marginBottom: "auto"}} onClick={""}>
