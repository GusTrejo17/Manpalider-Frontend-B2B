...
class ArticulosVentaModal extends Component {
    ...
    render (){
        ...
        return (
        <div> 
            {/*--------------- MODAL ARTICULOS VENTA ---------------*/}
            <div className="modal fade" id="ModalVenta" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" >
...
export default ArticulosVentaModal