    ...
    changeQuantity = (index, item, event) => {
        ...
        if (item.U_MultiploVenta !== null && item.U_MultiploVenta !== 0) {
            ...
            if (multiplo == 0) {
                ...
                //Calcular el multiplo mas cercano para la cantidad de un card de los productos mas papulares
                    ...
                    {false ?
                        <Carousel autoPlay partialVisible={false} responsive={responsive} autoPlaySpeed={5000} infinite={true} removeArrowOnDeviceType={["tablet", "mobile", "tablet1", "tablet2"]} >
                            {items2 && items2.map((item, index) => {
                                ...
                                return (
                                    <div id="ItemsSlider" style={{ display: "flex", justifyContent: "center", maxWidth: "18rem", maxHeight: "28rem", textAlign: "center", position: "relative", paddingRight: "1rem", paddingLeft: "1rem", paddingBottom: '1rem' }} key={index}>
                                        ...
                                        <div className="item card" style={{ position: "relative", width: "380px", marginTop: "4px", minHeight: "364px", padding: "1rem", backgroundColor: config.itemsList.backgroundColor }}>
                                            <div className="imageCard">
                                                <div style={{ display: (!item.U_FMB_Handel_Promo || item.U_FMB_Handel_Promo === '' || item.U_FMB_Handel_Promo == 0 ? 'none' : 'table') }}>
                                                    <div className="font-weight-bold ribbon" styles={{ position: "absolute", }} style={{ top: "-3px", left: "-5px" }} onClick={() => openItemDetails(item)}>
                                                        <span>
                                                ...
                                                <div className="card-body" style={{ height: "fit-content", margin: 0, padding: "2px", minHeight: "180px", color: config.itemsList.textColor }}>
                                                    <div>
                                                        {/* Se redujo el tamaño de la letra y se redojo en 1 el tamaño del margen izquierdo */}
                                                        <p className="card-subtitle text-left" style={{ fontSize: 15, marginLeft: 2, color: config.itemsList.textPrice2 }}>
                                            ...
                                            <div className="card-footer" style={{ padding: 0, border: 'none'/*, marginTop:"21px",borderTop: "transparent"*/ }}>
                                                        ...
                                                        <div className="col-3 cantidad" style={{ padding: 0 }}>
                                                            {item.Unidades === "Unidades" ?
                                                                <input
                                                                    ...
                                                                    placeholder="1"
                                                                    style={{ textAlign: "left", marginTop: 1, height: 38.5, width: "117%", fontSize: "84%" }}
